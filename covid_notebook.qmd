...
plot(covidw_tsp,
  ...
  main = "Evolution des tendances de mobilité pour les commerces et loisirs durant la période Covid (2020-2021, semaine)")
...
plot(covidwe_tsp,
  xlab = "Temps",
  ylab = "Tendance de mobilité pour les commerces et loisirs",
  main = "Evolution des tendances de mobilité pour les commerces et loisirs durant la période Covid (2020-2021, week-end)")
```
...
```{r tsd_p}
covidw_tsd_p <- tsd(covidw_tsp, method = "average", type = "additive", order = 6, times = 10)
plot(covidw_tsd_p, col = 1:3)
covidwe_tsd_p <- tsd(covidwe_tsp, method = "average", type = "additive", order = 6, times = 10)
plot(covidwe_tsd_p, col = 1:3)
```
