...
Après avoir mis en évidence une tendance générale de la mobilité dans les transports, il est intéressant d’aller plus loin en séparant les différentes composantes de la série temporelle. La décomposition permet de distinguer la tendance de fond, les variations saisonnières éventuelles et le bruit résiduel.

Pour cela, une décomposition additive de la série est réalisée à l’aide de la fonction tsd(), ce qui facilite l’interprétation des différentes composantes de la mobilité dans les transports.
...
Afin de faciliter l’analyse, il est donc pertinent d’extraire la composante lissée de la série. Cette étape permet de se concentrer uniquement sur la dynamique globale des transports, en éliminant les variations ponctuelles et le bruit résiduel.
