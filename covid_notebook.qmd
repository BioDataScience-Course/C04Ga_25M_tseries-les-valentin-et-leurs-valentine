...
# Sélection uniquement des week-ends
covidw_weekend <- covidw[covidw$weekdays %in% c("Saturday", "Sunday"), ]
...
```{r}
covid_2021_ts <- ts(covid$parcs, start = c(2021, 1),  end = c(2021, 365), frequency = 365)
plot(covid_2021_ts)
```
